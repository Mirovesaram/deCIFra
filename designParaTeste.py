...
"""E bom, pelos primeiros comentários que esse código
foi gerado com o designer do pyqt5, eu ia manter a versão
que eu estava fazendo manualmente sem a utilização do
designer mas por avisos de 'deprecação' que eu recebia
do terminal e por não ter entendido a causa e o mau uso
optei por utilizar o molde criado e adicionar as funções 
e os eventos por aqui"""
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.caixaRadiacoes_2.setGeometry(QtCore.QRect(10, 390, 80, 30))
        font = QtGui.QFont()
        font.setPointSize(11)
        ...
        #para aparecer aos usuários e também ser o mesmo valor
        for self.item in self.itens:
            self.caixaRadiacoes_2.addItem(self.item,userData=self.item)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.caixaRadiacoes_2.setItemText(0, _translate("MainWindow", "CuKa"))
        self.caixaRadiacoes_2.setItemText(1, _translate("MainWindow", "CuKa1"))
        self.caixaRadiacoes_2.setItemText(2, _translate("MainWindow", "CuKa2"))
        self.caixaRadiacoes_2.setItemText(3, _translate("MainWindow", "CuKb1"))
        self.caixaRadiacoes_2.setItemText(4, _translate("MainWindow", "CoKb1"))
        self.caixaRadiacoes_2.setItemText(5, _translate("MainWindow", "CoKa1"))
        self.caixaRadiacoes_2.setItemText(6, _translate("MainWindow", "CoKa2"))
        self.caixaRadiacoes_2.setItemText(7, _translate("MainWindow", "CoKa"))
        self.caixaRadiacoes_2.setItemText(8, _translate("MainWindow", "FeKb1"))
        self.caixaRadiacoes_2.setItemText(9, _translate("MainWindow", "FeKa1"))
        self.caixaRadiacoes_2.setItemText(10, _translate("MainWindow", "FeKa2"))
        self.caixaRadiacoes_2.setItemText(11, _translate("MainWindow", "FeKa"))
        self.caixaRadiacoes_2.setItemText(12, _translate("MainWindow", "CrKb1"))
        self.caixaRadiacoes_2.setItemText(13, _translate("MainWindow", "CrKa1"))
        self.caixaRadiacoes_2.setItemText(14, _translate("MainWindow", "CrKa2"))
        self.caixaRadiacoes_2.setItemText(15, _translate("MainWindow", "CrKa"))
        self.caixaRadiacoes_2.setItemText(16, _translate("MainWindow", "MoKa"))
        self.caixaRadiacoes_2.setItemText(17, _translate("MainWindow", "MoKa1"))
        self.caixaRadiacoes_2.setItemText(18, _translate("MainWindow", "MoKa2"))
        self.caixaRadiacoes_2.setItemText(19, _translate("MainWindow", "MoKb1"))
        self.caixaRadiacoes_2.setItemText(20, _translate("MainWindow", "AgKa"))
        self.caixaRadiacoes_2.setItemText(21, _translate("MainWindow", "AgKa1"))
        self.caixaRadiacoes_2.setItemText(22, _translate("MainWindow", "AgKa2"))
        self.caixaRadiacoes_2.setItemText(23, _translate("MainWindow", "AgKb1"))
