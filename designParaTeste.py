...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.botaoComparar = QtWidgets.QPushButton(self.tab)
        self.botaoComparar.setGeometry(QtCore.QRect(240, 470, 120, 40))
        self.botaoComparar.setObjectName("botaoComparar")
        self.labelSelecCIF = QtWidgets.QLabel(self.tab)
        self.labelSelecCIF.setGeometry(QtCore.QRect(0, 0, 600, 50))
        font = QtGui.QFont()
        ...
        self.botaoSelecCIF = QtWidgets.QPushButton(self.tab)
        ...
        self.labelCaminhoCIFs = QtWidgets.QLabel(self.tab)
        self.labelCaminhoCIFs.setGeometry(QtCore.QRect(0, 80, 600, 50))
        font = QtGui.QFont()
        font.setPointSize(13)
        ...
        self.labelSelecPadrao = QtWidgets.QLabel(self.tab)
        self.labelSelecPadrao.setGeometry(QtCore.QRect(0, 130, 600, 50))
        font = QtGui.QFont()
        font.setPointSize(13)
        ...
        self.botaoSelecPadrao = QtWidgets.QPushButton(self.tab)
        ...
        self.labelCaminhoPadrao = QtWidgets.QLabel(self.tab)
        self.labelCaminhoPadrao.setGeometry(QtCore.QRect(0, 210, 600, 50))
        font = QtGui.QFont()
        font.setPointSize(13)
        ...
        self.labelSelecRadiacao = QtWidgets.QLabel(self.tab)
        self.labelSelecRadiacao.setGeometry(QtCore.QRect(0, 260, 600, 50))
        font = QtGui.QFont()
        font.setPointSize(13)
        ...
        self.caixaRadiacoes = QtWidgets.QComboBox(self.tab)
        ...
        """Eu tive que adicionar esse comando 
        de ajustar o tamanho a partir do texto
        entregyue pois o tamanho fixo que eu coloquei 
        era menor do que determinadas opções"""
        self.caixaRadiacoes.adjustSize()
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab), _translate("MainWindow", "Comparar"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.Tab_2), _translate("MainWindow", "Detectar picos"))
